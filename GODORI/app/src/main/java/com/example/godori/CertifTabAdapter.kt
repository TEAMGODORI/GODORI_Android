...
//
//class CertifTabAdapter(fm : FragmentManager) : FragmentStatePagerAdapter(fm, BEHAVIOR_RESUME_ONLY_CURRENT_FRAGMENT) {
...
//        4 -> CertifTabUpload1Fragment()
//        5 -> CertifTabUpload2Fragment()
//        6 -> CertifTabUpload3Fragment()
