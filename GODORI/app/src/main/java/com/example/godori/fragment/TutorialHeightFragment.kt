 ...
 * Use the [TutorialHeightFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class TutorialHeightFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_tutorial_height, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment TutorialHeightFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            TutorialHeightFragment().apply {
